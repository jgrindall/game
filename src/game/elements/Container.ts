...
Container.publicPropertyNames = Element.publicPropertyNames;
Container.propertyNames = [...Container.publicPropertyNames, "offset", "on", "value"];
Container.methodNames = [...Element.methodNames];
Container.inspectablePropertyNames = [...Element.inspectablePropertyNames];
