...
class Fire2Pipeline extends Phaser.Renderer.WebGL.Pipelines.SinglePipeline {
	// the unique id of this pipeline
	public static readonly KEY = "Fire2Pipeline";
...
float CUTOFF = 0.5; //depth less than this, show black
